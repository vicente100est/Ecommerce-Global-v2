            ...
            <div class="tab-content">
                    ...
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-sm-12">
                            <div class="col-lg-6 col-md-6 col-sm-6 pad-all">
                                <img class="img-responsive logo" src="<?php echo $this->crud_model->logo('home_top_logo'); ?>" alt="Seven" width="55%"><br><br>
                ...
                <div id="half_<?php echo $ven; ?>" class="tab-pane fade">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="col-lg-6 col-md-6 col-sm-6 pad-all">
                                <img src="<?php echo $this->crud_model->logo('home_top_logo'); ?>" alt="Seven" width="55%">
                            </div>
                            <div class="col-lg-6 col-md-6 col-sm-6 pad-all">
                                <b class="pull-right">
